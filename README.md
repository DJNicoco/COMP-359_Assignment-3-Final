...
Below is a breakdown of our roles and the key methods in our implementations: 
...
6. Visualize all color combination trees combined
7. Reconstruct and visualize the optimal BST structure
...
- the visualize_reconstructed_bst method visualizes the reconstructed optimal BST based on the backtracking. <br>
- the backtrack_optimal_bst method reconstructs the optimal BST from the root table generated by the dynamic programming.<br>
...
**Reconstruct and visualize the optimal BST structure:** Once the optimal BST’s cost is calculated, the program can reconstruct the structure based on the root table using backtracking. After reconstructing the optimal BST, this method visualizes the tree.
